...
This improved version of the document [Podman and Ubuntu 20.04 LTS]({% post_url 2020-06-10-Podman_and_Ubuntu %}) deals with Podman root and rootless containers and pods and managing them with Systemd. It is tested with Debian 10 and Ubuntu 20.04 LTS.<!--more-->
